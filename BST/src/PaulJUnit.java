...
public class PaulJUnit {
    ...
    public void testNoArgumentConstructor1() {
    ...
    public void collectionsConstructorException1() {
        BST<Integer> bstCollection = new BST<Integer>(null);
    }

    @Test(timeout = TIMEOUT)
    public void testCollectionsConstructor1() {
        ArrayList<Integer> a = new ArrayList<Integer>();
        BST<Integer> bstCollection = new BST<Integer>(a);

        assertEquals(0, bstCollection.size());
        assertNull(bstCollection.getRoot());
    }

    @Test(timeout = TIMEOUT)
    public void testCollectionsConstructor2() {
        ArrayList<Integer> a = new ArrayList<Integer>();
        a.add(1);
        BST<Integer> bstCollection = new BST<Integer>(a);

        assertEquals(1, bstCollection.size());
        assertEquals((Integer)1, bstCollection.getRoot().getData());
    }

    @Test(timeout = TIMEOUT)
    public void testCollectionsConstructor3() {
        ArrayList<Integer> a = new ArrayList<Integer>();
        a.add(2);
        a.add(1);
        BST<Integer> bstCollection = new BST<Integer>(a);

        assertEquals(2, bstCollection.size());
        assertEquals((Integer)2, bstCollection.getRoot().getData());
        assertEquals((Integer)1, bstCollection.getRoot().getLeft().getData());
        assertNull(bstCollection.getRoot().getRight());
    }

    @Test(timeout = TIMEOUT)
    public void testCollectionsConstructor4() {
        ArrayList<Integer> a = new ArrayList<Integer>();
        a.add(2);
        a.add(1);
        a.add(3);
        ...
        assertEquals(3, bstCollection.size());
        assertEquals((Integer)2, bstCollection.getRoot().getData());
        assertEquals((Integer)1, bstCollection.getRoot().getLeft().getData());
        assertEquals((Integer)3, bstCollection.getRoot().getRight().getData());
    }

    @Test(timeout = TIMEOUT)
    public void testCollectionsConstructor5() {
        ArrayList<Integer> a = new ArrayList<Integer>();
        a.add(5);
        a.add(3);
        a.add(7);
        ...
        assertEquals(7, bstCollection.size());
        assertEquals((Integer)5, bstCollection.getRoot().getData());
        assertEquals((Integer)3, bstCollection.getRoot().getLeft().getData());
        assertEquals((Integer)2, bstCollection.getRoot().getLeft().getLeft().getData());
        assertEquals((Integer)4, bstCollection.getRoot().getLeft().getRight().getData());
        assertEquals((Integer)7, bstCollection.getRoot().getRight().getData());
        assertEquals((Integer)6, bstCollection.getRoot().getRight().getLeft().getData());
        assertEquals((Integer)8, bstCollection.getRoot().getRight().getRight().getData());
    }
